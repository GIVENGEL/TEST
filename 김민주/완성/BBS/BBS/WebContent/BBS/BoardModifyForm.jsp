...
<title>게시글 수정하기</title>
 ...
 <body>
	<h4> 게시판 글 수정하기 </h4><br/>
	<form name='frm' method='post' action="/BBS/BoardControl?cmd=modifyAction-page&seq=<%=seq%>">
	...
	<input type='button' value='목록보기' onclick="location.href='/BBS/BoardControl?cmd=list-page'">
	</form>
