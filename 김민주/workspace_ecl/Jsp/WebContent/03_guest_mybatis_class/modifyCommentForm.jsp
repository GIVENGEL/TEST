...
<body>
	<form action="modifyComment.jsp">
		<table border="1">
			...
			<tr>
				<td>메세지</td>
				<td><input type="text" name="commentContent" value=<%=comment.getCommentContent() %> />
					<input type="hidden" name="commentNo" value=<%=comment.getCommentNo()%> /></td>
			</tr>
			<tr>
				<td>등록일
