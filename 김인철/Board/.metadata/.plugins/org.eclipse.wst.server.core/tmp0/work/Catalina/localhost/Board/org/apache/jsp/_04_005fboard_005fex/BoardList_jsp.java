 ...
 * Generated at: 2021-07-08 11:13:16 UTC
...
ArrayList<BoardVO> mList =  service.getPageList(start, length);
 ...
 int pageHeader = (seq%group!=0 || (request.getAttribute("seq2")==null) || seq==0 ) ? seq/group : seq/group-1;
      ...
      out.write("<script>\r\n");
      out.write("$(function(){\r\n");
      out.write("var group = 5;\r\n");
      out.write("var pg = $(\".pg\");\r\n");
      out.write("	pg.css(\"cursor\",\"pointer\").click(function(){\r\n");
      out.write("		var seq = $(this).attr('id');\r\n");
      out.write("		location.href='/Board/BoardControl?cmd=page-action&&seq='+seq;\r\n");
      out.write("	})\r\n");
      out.write("\r\n");
      out.write("var pre = $(\".pre\");\r\n");
      out.write("var next = $(\".next\");\r\n");
      out.write("\r\n");
      out.write("next.css(\"cursor\",\"pointer\").click(function(){\r\n");
      out.write("	var header = $(this).attr('id');\r\n");
      out.write("	location.href='/Board/BoardControl?cmd=page-action&&seq='+header*group;\r\n");
      out.write("})\r\n");
      out.write("\r\n");
      out.write("pre.css(\"cursor\",\"pointer\").click(function(){\r\n");
      out.write("	var header = $(this).attr('id');\r\n");
      out.write("	location.href='/Board/BoardControl?cmd=page-action&&seq='+header*group;\r\n");
      out.write("})\r\n");
      out.write("	\r\n");
 ...
 if( mList.isEmpty() ) { 
      ...
      out.write("</td>\r\n");
      out.write("			<td><a href=\"/Board/BoardControl?cmd=view-page&&seq=");
      out.print(mList.get(i).getSeq() );
      out.write('"');
      out.write('>');
	...
	if(seq==0){
      ...
      out.write("\" class=\"page-link pre\">Previous</a>\r\n");
      out.write("    </li>\r\n");
      out.write("	  ");
 ...
 if(seq/5==headnum){
      ...
      out.write("	  <li class=\"page-item disabled\">\r\n");
      out.write("      <a id=\"");
      out.print(pageHeader+1);
      out.write("\" class=\"page-link next\" >Next</a>\r\n");
      out.write("    </li>\r\n");
      out.write("	  ");
      ...
      out.write("	\r\n");
      out.write("	\r\n");
      out.write("	<input type=\"button\" value=\"글쓰기\" onclick=\"location.href='/Board/BoardControl?cmd=write-page'\" class=\"btn btn-warning float-right\">\r\n");
      out.write("	</div>\r\n");
      out.write("	\r\n");
