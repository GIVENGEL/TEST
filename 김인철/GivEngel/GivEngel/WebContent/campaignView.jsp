                ...
                <div class="col-lg-4 col-md-5 order-md-1 order-2">
                    <div class="blog__sidebar">
                        ...
                        <div class="blog__sidebar__item">
                            <h4>Categories</h4>
                            <ul>
                                <li><a href="#">전체 상품 이동</a></li>
                                <li><a href="#">WHERE ? 카테고리 별 이동1</a></li>
                                <li><a href="#">WHERE ? 카테고리 별 이동2</a></li>
                                <li><a href="#">WHERE ? 카테고리 별 이동3</a></li>
                                <li><a href="#">WHERE ? 카테고리 별 이동4</a></li>
                            </ul>
                        </div>
                        <div class="blog__sidebar__item">
                            <h4>다른 후원 글</h4>
                ...
                <div class="col-lg-8 col-md-7 order-md-1 order-1">
                    <div class="blog__details__text">
                        ...
                        <button type="button" name="donation"
											class="btn btn-block btn-success" style="height:150px"><spaa class="display-4">후원하기!</spaa></button>
                    </div>
