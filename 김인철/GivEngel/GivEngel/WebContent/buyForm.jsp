            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-md-6">
                    <div class="product__details__text">
                        ...
                        <a href="#" class="heart-icon"><span class="icon_heart"></span></a>
                        <ul>
                            <li><b>상품 카테고리</b> <span>[카테고리]</span></li>
                            <li><b>남은 재고</b> <span>[현재개수]<samp> /[총 개수]</samp></span></li>
                            <li><b>사이즈</b> <span>XL/M</span></li>
                            <li><b>공유하기</b>
                                <div class="share">
                        ...
                        <ul class="nav nav-tabs" role="tablist">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" data-toggle="tab" href="#tabs-2" role="tab"
                                    aria-selected="false">GivEngel 이용 수칙</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" data-toggle="tab" href="#tabs-3" role="tab"
                                    aria-selected="false">리뷰 <span>(댓글 수)</span></a>
                            </li>
                        </ul>
                        <div class="tab-content">
                            ...
                            <div class="tab-pane " id="tabs-3" role="tabpanel">
                                <div class="product__details__tab__desc" style="text-align:center">
                                    <h6>for문으로 댓글 구현</h6>
                                    <input class="w-50"  placeholder="댓글을 입력해주세요." style="hegith:40px"></input>
                                    <button type="button" name="go"
											class="btn btn-block btn-success w-25 center">댓글 달기</button>
                                </div>
                            </div>
                        </div>
                    </div>
