		...
		<div class="container">
			<div class="row">
										...
										<table class="table table-boardered">
											...
											<tr>
												...
												<td><input type="password" class="form-control"
													name="pass1" placeholder="비밀번호를 입력해주세요"></td>
											</tr>
											...
											<tr>
												<td colspan="2"><input type="submit"
													class="btn btn-block btn-success" value="회원가입"> 
													<input id="cancle" type="button" class="btn btn-block btn-success" value="되돌아가기">
												</td>
											</tr>
				...
				<div class="hidden-md hidden-lg col-lg-6">
					<img class="" src="img/join.jpg" alt="">
				</div>
			</div>
		</div>
	</section>
